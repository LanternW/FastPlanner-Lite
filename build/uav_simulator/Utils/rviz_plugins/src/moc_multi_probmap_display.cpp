...
#include "../../../../../src/uav_simulator/Utils/rviz_plugins/src/multi_probmap_display.h"
...
struct qt_meta_stringdata_rviz__MultiProbMapDisplay_t {
    QByteArrayData data[4];
    char stringdata0[55];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rviz__MultiProbMapDisplay_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rviz__MultiProbMapDisplay_t qt_meta_stringdata_rviz__MultiProbMapDisplay = {
    {
QT_MOC_LITERAL(0, 0, 25), // "rviz::MultiProbMapDisplay"
QT_MOC_LITERAL(1, 26, 11), // "updateTopic"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 15) // "updateDrawUnder"

    },
    "rviz::MultiProbMapDisplay\0updateTopic\0"
    "\0updateDrawUnder"
};
...
const QMetaObject rviz::MultiProbMapDisplay::staticMetaObject = {
    { &Display::staticMetaObject, qt_meta_stringdata_rviz__MultiProbMapDisplay.data,
      qt_meta_data_rviz__MultiProbMapDisplay,  qt_static_metacall, nullptr, nullptr}
};
...
void *rviz::MultiProbMapDisplay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rviz__MultiProbMapDisplay.stringdata0))
