...
float64 z"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.loop_rate, _x.voltage, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z, _x.linear_acceleration.x, _x.linear_acceleration.y, _x.linear_acceleration.z, _x.pressure_dheight, _x.pressure_height, _x.magnetic_field.x, _x.magnetic_field.y, _x.magnetic_field.z,) = _get_struct_H16d().unpack(str[start:end])
      start = end
      end += 8
      self.radio_channel = str[start:end]
      start = end
      end += 1
      (self.seq,) = _get_struct_B().unpack(str[start:end])
      return self
...
def _get_struct_B():
    ...
    return _struct_B
_struct_H16d = None
def _get_struct_H16d():
    global _struct_H16d
    if _struct_H16d is None:
