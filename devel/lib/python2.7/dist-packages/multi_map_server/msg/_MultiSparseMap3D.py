    ...
    try:
      ...
      for val1 in self.maps:
        ...
        for val2 in val1.lists:
          ...
          buff.write(_struct_I.pack(length))
          pattern = '<%si'%length
          buff.write(struct.Struct(pattern).pack(*val2.upper))
          length = len(val2.lower)
          buff.write(_struct_I.pack(length))
          pattern = '<%si'%length
          buff.write(struct.Struct(pattern).pack(*val2.lower))
          length = len(val2.mass)
          buff.write(_struct_I.pack(length))
          pattern = '<%si'%length
          buff.write(struct.Struct(pattern).pack(*val2.mass))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          val2.upper = s.unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          pattern = '<%si'%length
          ...
          val2.lower = s.unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          pattern = '<%si'%length
          ...
          val2.mass = s.unpack(str[start:end])
