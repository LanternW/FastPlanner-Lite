...
if("TRUE" STREQUAL "TRUE")
  set(planner_manager_SOURCE_PREFIX /home/lantern/ROS_workspace/MotionPlanning/src/planner_manager)
  set(planner_manager_DEVEL_PREFIX /home/lantern/ROS_workspace/MotionPlanning/devel)
  ...
  set(planner_manager_INSTALL_PREFIX /home/lantern/ROS_workspace/MotionPlanning/install)
...
if(NOT "/home/lantern/ROS_workspace/MotionPlanning/devel/include;/home/lantern/ROS_workspace/MotionPlanning/src/planner_manager/include " STREQUAL " ")
  set(planner_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/lantern/ROS_workspace/MotionPlanning/devel/include;/home/lantern/ROS_workspace/MotionPlanning/src/planner_manager/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'planner_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lantern/ROS_workspace/MotionPlanning/src/planner_manager/${idir}'.  ${_report}")
    endif()
...
set(depends "map_manager;planner_algorithm;roscpp;rospy;std_msgs;sensor_msgs;geometry_msgs;message_runtime")
foreach(depend ${depends})
  ...
  list(APPEND planner_manager_EXPORTED_TARGETS ${${planner_manager_dep}_EXPORTED_TARGETS})
endforeach()
