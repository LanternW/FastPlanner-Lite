...
if("TRUE" STREQUAL "TRUE")
  set(local_sensing_node_SOURCE_PREFIX /home/lantern/ROS_workspace/MotionPlanning/src/uav_simulator/local_sensing)
  set(local_sensing_node_DEVEL_PREFIX /home/lantern/ROS_workspace/MotionPlanning/devel)
  ...
  set(local_sensing_node_INSTALL_PREFIX /home/lantern/ROS_workspace/MotionPlanning/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'local_sensing_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lantern/ROS_workspace/MotionPlanning/src/uav_simulator/local_sensing/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND local_sensing_node_EXPORTED_TARGETS ${${local_sensing_node_dep}_EXPORTED_TARGETS})
endforeach()
