// Generated by gencpp from file planner_manager/PositionCommand.msg
// DO NOT EDIT!


#ifndef PLANNER_MANAGER_MESSAGE_POSITIONCOMMAND_H
#define PLANNER_MANAGER_MESSAGE_POSITIONCOMMAND_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::planner_manager::PositionCommand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::planner_manager::PositionCommand_<ContainerAllocator> const> ConstPtr;

}; // struct PositionCommand_

typedef ::planner_manager::PositionCommand_<std::allocator<void> > PositionCommand;

typedef boost::shared_ptr< ::planner_manager::PositionCommand > PositionCommandPtr;
typedef boost::shared_ptr< ::planner_manager::PositionCommand const> PositionCommandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::planner_manager::PositionCommand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::planner_manager::PositionCommand_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::planner_manager::PositionCommand_<ContainerAllocator1> & lhs, const ::planner_manager::PositionCommand_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::planner_manager::PositionCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::planner_manager::PositionCommand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::planner_manager::PositionCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::planner_manager::PositionCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::planner_manager::PositionCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::planner_manager::PositionCommand_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::planner_manager::PositionCommand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::planner_manager::PositionCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4712f0609ca29a79ULL;
  static const uint64_t static_value2 = 0xaf79a35ca3e3967aULL;
};

template<class ContainerAllocator>
struct DataType< ::planner_manager::PositionCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::planner_manager::PositionCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::planner_manager::PositionCommand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::planner_manager::PositionCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::planner_manager::PositionCommand_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // PLANNER_MANAGER_MESSAGE_POSITIONCOMMAND_H
